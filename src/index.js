...
const AUTO_KEYS = new Set(['afk', 'claims', 'quests', 'dungeon', 'evolve', 'breed', 'gacha', 'premiumEgg', 'gemcraft', 'buyegg', 'autostamina', 'relic', 'relicEnhance', 'relicDismantle', 'companion', 'epoch', 'pvp', 'slots', 'marketBuy', 'marketSell']);
const AUTO_DEFAULTS = {
